...
public class Program1 {
    public static void main(String[] args) {
        ...
        System.out.println(label1.equals(label4));
        ...
        String row2 = "   This?is a short, sentence. with !!! separators";
        System.out.println(row2.startsWith("This"));
        System.out.println(row2.contains("short"));
        System.out.println(row2.indexOf("short"));
        System.out.println(row2.lastIndexOf('s'));
